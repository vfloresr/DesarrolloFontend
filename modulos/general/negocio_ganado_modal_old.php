                    ...
                    <div class="row">
					   <div class="col-xs-4 form-inline">
						  <h3 class="mb15">Numero Negocio:</h3>
							 <input type="text"  class="form-control" id="numero_negocio_c1"   name = "numero_negocio_c1" maxlength="1" style="width:20%" value='<?php echo $ano_actual ?>' title="Ingrese Ultimo Digito del Año Actual Ej:5 "></input>
