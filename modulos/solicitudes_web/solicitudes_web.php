<div class="section-separator">
    <h2 id="solicitudes_title" class="pl15 section-title" style="color:#696969;"><i class="glyphicon glyphicon-list-alt" ></i> Solicitudes web</h2>
	...
	<div id="solicitudes_section" class="col-md-12 section-container">
        <div class="panel">
			...
			<div class="panel-heading">
			 	  ...
			 	  <input type="checkbox" name="check_disponibilidad" data-on-text="Si" data-on-color="success" data-off-text="No" data-off-color="danger" style="width: 329px; margin-left: -43px;"></p>
			</div>
            ...
            <div class="panel-body">
                <div class="tab-content pn br-n">
                    ...
                    <div id="tab3_2" class="mostrar-pendiente-table-solicitudes-web tab-pane">
                        <div class="row">
                            <table id="negociacion_table_solicitudes_web" class="table table-striped table-hover table table-bordered table-striped custom-cross tabla-negociacion" cellspacing="0" width="100%">
                                <thead class="danger">
                                    <tr>
                                        <th class="no-sort"></th>
                                        <th class="no-sort">Oportunidad</th>
