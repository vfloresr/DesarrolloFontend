...
{ 
	...
	private function getParametros()
	{
		/** INICIO: URL ENTORNOS */
			...
			$parametros['url_prototipo'] = "http://desa-backend.cochadigital.com/service/v4_1/rest.php";
		/** FIN */
		 /****Ruta de Configuracion Encuesta */
	 	
		   $parametros ['url_config_encuesta'] = 'http://qa-survey.cochadigital.com/setToken.php?encuesta=146131&token=';
		...
		/** INICIO: CONFIGURACIONES PARA SOLICITUDES WEB */
				...
				/** INICIO: URL PARA ABRIR ESTADO CROSS SELLING */
				$parametros['url_set_editar_estado_cross_selling'] = 'ws/wss.php?func=set_editar_cambio_estado_cross_selling';
				/** FIN */
				
				/** INICIO: URL PARA ABRIR ESTADO RECOMPRA */
				$parametros['url_set_editar_estado_recompra'] = 'ws/wss.php?func=set_editar_cambio_estado_recompra';
				/** FIN */
				
				/** INICIO: URL PARA ABRIR ESTADO FUGADOS */
				$parametros['url_set_editar_estado_fugados'] = 'ws/wss.php?func=set_editar_cambio_estado_fugados';
				/** FIN */
		...
		/** INICIO: CONFIGURACIONES PARA CUMPLEAÑOS */
			/** INICIO: URL OBTENER DATOS PARA LAS TABLAS */
				...
				$parametros['url_editar_cumple_auto'] = "ws/wss.php?func=set_editar_cumple_auto"; //agregado el 12-05
