<div class="section-separator">
   <h2 id="fugados_title" class="pl15 section-title" style="color:#696969;"><i class="glyphicon glyphicon-list-alt"></i> Fugados</h2>
  <div id="fugados_section" class="col-md-12 section-container">
    <div class="alert alert-success alert-dismissable text-center" style="display:none;font-size:16px;" id="msj_estado_fugados" data-dismiss="alert">Fugado Abierto...</div>
	 <div class="panel">
