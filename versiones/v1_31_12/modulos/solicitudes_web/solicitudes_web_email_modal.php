  ...
  <div style="width: 100%; height: 90%; margin-top: 0%;" class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
		...
		<h2 class="modal-title custom_align"> <i class="fa fa-envelope-o"></i> <span>Formulario Envío Cotización</span> - <span style="color: #3498db !important; cursor: pointer !important;" data-toggle="popover" class="contacto_nombre"></span></h2>
      </div>
		 ...
		 <form class="form-horizontal row">
						...
						<div id="collapseTarifas" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingTarifas">
						  <div class="panel-body">
							<div class="row">
								...
								<div style="margin: 5px;" class="row">
									<div class="col-xs-4 col-sm-4 col-md-4 col-lg-4"> 
										<input type="checkbox" name="mail_modal_solicitud_tarifas" value="Plan Familiar 2 ADL + 2 NIÑOS compartiendo habitación"> Plan Familiar 2 ADL + 2 NIÑOS compartiendo habitación
									</div>
									<div class="col-xs-2 col-sm-2 col-md-2 col-lg-2"> 
										<input type="text" name="mail_modal_solicitud_tarifas_value" class="form-control input-sm" onkeydown="FuncionesGenerales.validarDecimal(this)" value="0.00" placeholder="0.00">
									</div>
           ...
           <hr class="alt short">
 			  <div class="row">	
				 <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
				   <div class="col-xs-12 col-sm-12 col-md-5 col-lg-5">
					  <label class="label-form-mail">Documentación</label>
				   </div>
				   <div class="col-xs-12 col-sm-12 col-md-7 col-lg-7">
					   <select name="mail_modal_solicitud_web_documentacion_value" class="form-control input-sm">
							<option value="-999">Selecccionar...</option>
							<option value="Para este viaje se requiere contar con pasaporte vigente (mínimo 6 meses a la fecha de regreso) y en buen estado.">Contar con pasaporte</option>
