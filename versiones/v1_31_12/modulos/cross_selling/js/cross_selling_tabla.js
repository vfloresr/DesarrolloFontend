				...
				if(!$.fn.dataTable.isDataTable('#abierto_table'))
				{
					 ...
					 ajax: {
					  ...
					  'dataSrc': function ( json ) {
							...
							for(i = 0; i < json.length; i++){
								...
								json[i].destino = '<div style="padding:10px;"> <strong>' + json[i].destino   + '</strong> <span class="label label-default">'+json[i].dias+' días</span> </br> ' + json[i].ruta + ' </div>';
				  ...
				  $.fn.dataTableExt.oApi.fnActualizarRegistroTablaCrossSellingNuevas = function ()
				  {
						...
						$.get(Configuraciones.getConfiguraciones().url_busca_oportunidad, data).done(function(response)
						{
							...
							var destino = '<div style="padding:10px;"> <strong>' + json.destino   + '</strong> <span class="label label-default">'+json.dias+' días</span> </br> ' + json.ruta + ' </div>';
							...
							CrossSellingTabla.abierto.fnUpdate(monto_venta, nRow, 6, false);
							CrossSellingTabla.abierto.fnUpdate(monto_oportunidad, nRow, 7, false);
						});
				  }
