            ...
            <div class="modal-body">
            	...
            	<form class="form-horizontal row">
                    <div class="row">
					   <div class="col-xs-4 form-inline">
						  <h3 class="mb15">Numero Negocio:</h3>
							 <input type="text"  class="form-control" id="numero_negocio_c1"   name = "numero_negocio_c1" maxlength="1" style="width:20%" value='<?php echo $ano_actual ?>' title="Ingrese Ultimo Digito del Año Actual Ej:5 " disabled></input>
                             ...
                             <input type="text"  class="form-control" id="numero_negocio_c3"   name = "numero_negocio_c3" maxlength="3" style="width:30%" title="Ingrese Tres Numeros Correlativos ej:123 "></input>
					   </div>
					...
					<div class="col-xs-12 col-sm-6">
                        ...
                        <div class="checkbox-custom mb5">
                            <input type="checkbox" onclick="validar(this);" id="cross-selling-productos-6" value="translados">
