			...
			<div class="row">
			  <div class="col-xs-12 col-sm-12 col-md-12">
				<h3 class="mb15">Motivo no ganado <code class="required-field-modal-motivos-solicitudes-web" style="display: none;" >* Obligatorio</code></h3>
					<SELECT type="text" name="tipo_cierre_perdido_oportunidades_web" class="form-control" id="tipo_cierre_perdido_oportunidades_web">
					<OPTION VALUE="">«« SELECCIONE »»</OPTION> 
					<OPTION VALUE="Por falta de disponibilidad en tarifas desde">Por falta de disponibilidad en tarifas desde</OPTION> 
					<OPTION VALUE="Precio descompetitivo">Precio descompetitivo</OPTION> 
					<OPTION VALUE="Cliente solo vitrineando">Cliente solo vitrineando</OPTION> 
					...
					<OPTION VALUE="Otra ( Agregar en Comentarios )">Otra ( Agregar en Comentarios )</OPTION> 
				</SELECT>
			  </div>
			</div>
			<!-- <div class="row">
