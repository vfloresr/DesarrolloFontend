<div class="section-separator">
    <h2 id="oportunidad_title" class="pl15 section-title"><i class="glyphicon glyphicon-list-alt"></i> Prueba Jose Gregorio</h2>
    <div id="prueba_section" class="col-md-12 section-container">
        <div class="panel">
